          ...
          <table>
            ...
            <tbody>
              ...
              <?php while($row = mysqli_fetch_assoc($result)) {
                ...
                <td><button class="btn btn-primary"> <a href="user-edit.php?id=<?= $row['id'] ?>">Edit</a></button></td>
                <form action="code.php" method="POST" class="d-inline">
                <td><button type="submit" name="delete_user" class="btn btn-danger" value="<?= $row['id'] ?>">Delete</button></td>
              </tr>
                <?php 
                } ?>
            </tbody>
