...
if(isset($_POST['submit'])){
   ...
   if(mysqli_num_rows($result) > 0){
      ...
      if($pass != $cpass){
         ...
         $insert = "INSERT INTO user_form(name, email, number, password, user_type) VALUES('$name','$email','$number','$pass','$user_type')";
...
<div class="form-container">
   ...
   <form action="" method="post">
      ...
      <input type="number" name="number" required placeholder="enter your mobile number" autocomplete="off">
