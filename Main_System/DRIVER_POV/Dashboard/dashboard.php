  ...
  <section class="home-section">
    <nav>
      ...
      <div class="profile-details">
        <img src="car.jpg" alt="">
        <h4><span><?php echo $_SESSION['driver_name'] ?></span></h4>
      </div>
    </nav>
    ...
    <div class="home-content">
      <div class="overview-boxes">
        <div class="box">
          <div class="right-side">
            <div class="box-topic">Parking History</div>
            <div class="number">-----</div>
          </div>
        </div>
        <div class="box">
          <div class="right-side">
            <div class="box-topic">Time In</div>
            <div class="number">11:11</div>
          </div>
        </div>
        <div class="box">
          <div class="right-side">
            <div class="box-topic">Time Out</div>
            <div class="number">12:12</div>
          </div>
        </div>
        <div class="box">
          <div class="right-side">
            <div class="box-topic">Payment Status</div>
            <div class="number">-----</div>
          </div>
        </div>
      </div>
      ...
      <div class="Parking-boxes">
        <div class="recent-Parking box">
          ...
          <div class="button">
            <a href="../PARKING LIST\park-list.php">See All</a>
          </div>
        </div>
