            ...
            <?php
                ...
                {  
                  ...
                  <form action="code.php" method="POST">
                    <div class="details">
                      <li><input type="hidden" name="user_id" value="<?= $user['id']?>"></li>
                      <li><input type="text" name="name" value="<?=$user['name']?>" autocomplete="off"></li>
                      <li><input type="number" name="number" value="<?=$user['number']?>" autocomplete="off"></li>
                      <li><input type="email" name="email" value="<?=$user['email']?>" autocomplete="off"></li>
                      <li><input type="password" name="password" placeholder="Enter password" autocomplete="off"></li>
                      <div class="button">
