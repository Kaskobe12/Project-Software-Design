        ...
        <div class="recent-Parking box">
          ...
          <div class="Parking-details">
            ...
            <?php
                ...
                {  
                  $slot = mysqli_fetch_array($query_run);
                    ?>
                <form action="code.php" method="POST">
                  <div class="details">
                  <li><input type="text" name="street" value="<?= $slot['street'] ?>"></li>
                  <li><input type="text" name="comadd" value="<?= $slot['comadd'] ?>"></li>
                  <li><input type="text" name="description" value="<?= $slot['description'] ?>"></li>
                  <li><input type="text" name="rate" value="<?= $slot['rate'] ?>"></li>
                  <li><input type="text" name="timeopen" value="<?= $slot['timeopen'] ?>"></li>
                  <li><input type="number" name="slots" value="<?= $slot['slots'] ?>"></li>
                  <li><input type="text" name="vehiclety" value="<?= $slot['vehiclety'] ?>"></li>
                  <li><input type="number" name="cnumber" value="<?= $slot['cnumber'] ?>"></li>
                  </div>
                  <div class="button">
