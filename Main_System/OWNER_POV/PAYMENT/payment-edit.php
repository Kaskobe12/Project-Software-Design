        ...
        <div class="recent-Parking box">
          ...
          <div class="Parking-details">
            <ul class="details">
              ...
              <li><a href="#">Select Mode Of Payment:</a></li>
              <li><a href="#">Name:</a></li>
            ...
            <li><input type="text" name="name" required placeholder="enter your name"></li>
            <li><input type="number" name="number" required placeholder="enter your number"></li>
            <li><a href="#">pending</a></li>
          </ul>
          </div>
          <div class="button">
            <a href="payment.php">Save</a>
          </div>
        </div>
      </div>
    </div>
